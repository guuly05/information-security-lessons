...
[![Version](https://img.shields.io/badge/version-2.0-blue.svg)](https://github.com/yourusername/information-security-repo)
[![Status](https://img.shields.io/badge/status-active-brightgreen.svg)]()
[![Language](https://img.shields.io/badge/language-English-red.svg)]()
[![Platform](https://img.shields.io/badge/platform-Kali%20Linux%20%7C%20Windows%20%7C%20macOS-lightgrey)]()
...
- The core principles of information security (Confidentiality, Integrity, Availability)
...
- Auditing, monitoring, and compliance requirements
...
- **Protecting** information assets through appropriate security controls
- **Determining** appropriate levels of protection based on asset classification
...
│   ├── Chapter_04_Business_Drivers.md
│   ├── Chapter_05_Access_Controls.md
│   ├── Chapter_06_Cryptography.md
│   ├── Chapter_07_Malware_Attack_Vectors.md
...
| Tool | Purpose |
| :--- | :--- |
| **Kali Linux** | Security testing, ethical hacking, vulnerability assessment |
...
The `books/` directory contains the following essential reading materials:

1. **Kim, D. & Solomon, M.G.** - *Fundamentals of Information Systems Security (4th Edition)* — The primary textbook for this course
2. **Sikorski, M. & Honig, A.** - *Practical Malware Analysis* — Hands-on guide to dissecting malicious software
3. **Carey, M.J. & Jin, J.** - *Tribe of Hackers* — Cybersecurity advice from the best hackers in the world
4. **Stuttard, D. & Pinto, M.** - *Web Application Hacker's Handbook* — Finding and exploiting security flaws
...
2. **Read the chapters** in sequential order (Chapters 1-9)
3. **Complete the labs** as they become relevant to each chapter
4. **Use the cheat sheets** for quick reference during labs
5. **Review the case studies** to understand real-world applications
6. **Follow the suggested learning path** below
...
3. **Complete hands-on labs** using the required software
4. **Test your understanding** using the chapter review questions
...
- [ ] Download the required books
- [ ] Review Chapter 1 materials
- [ ] Complete Lab 1: Kali Installation
...
5. **Think like an adversary** — The best defenders understand how attackers think
6. **Practice ethical hacking** — Always test in your own lab with proper authorization
7. **Stay current** — Follow security news and emerging threats
...
Detailed project specifications are provided in the `policy-templates/` directory.
...
All contributions that enhance the learning experience for students are welcome.
...
- All original content is free to use, adapt, and distribute for non-commercial teaching and learning
- When using or adapting these materials, please attribute the source
...
- **David Kim & Michael G. Solomon** — For their comprehensive textbook
- **Lockheed Martin** — For the Cyber Kill Chain framework
- **MITRE Corporation** — For the ATT\&CK Framework
- **NIST** — For the cybersecurity frameworks and guidelines
- **The Open Source Community** — For the tools and resources that make security education accessible
...
**Version:** 2.0
**Maintainer:** Guuleed Maxamuud Aw Abdi
